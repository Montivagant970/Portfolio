...
The present directory contains the project created for the purposes of learning the concepts of object-oriented programming, relational databases, and app development during my time at ELCA Information Technology.
